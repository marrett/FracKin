function [] = StereonetHackRM(trdv,plgv,intrad,sttype)
...
%
%StereonetHackRM by Randall Marrett
%darkened blue for great and small circles on 2013 Dec 27
...
for i=1:nCircles
    ...
    plot(path1(1:np1,1),path1(1:np1,2), 'Color', [0 0 0.7]);
    if np2 > 0
        plot(path2(1:np2,1),path2(1:np2,2), 'Color', [0 0 0.7]);
    end
end
...
for i=0:nCircles*2
    ...
    plot(path(:,1),path(:,2), 'Color', [0 0 0.7]);
end
